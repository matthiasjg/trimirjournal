 ...
 */
 ...
 public class Journal.LogDao : Object {
    ...
    private const string SQL_DB_FILE_NAME = "io_trimir_journal_1_0_0";
    ...
    public bool create_log (Journal.LogModel log) requires (__conn.is_opened ()) {
    ...
    */
    ...
    private void init_db (string db_file_name) {
        if (db_file_name == null || db_file_name == "") {
            critical ("Missing valid db file name: %s", db_file_name);
        } else {
