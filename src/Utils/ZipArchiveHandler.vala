 ...
 * SPDX-FileCopyrightText: 2019 Felipe Escoto <felescoto95@hotmail.com>
 * SPDX-FileCopyrightText: 2019-2020 Alessandro "Alecaddd" Castellani <castellani.ale@gmail.com>
 * SPDX-FileCopyrightText: 2021 Matthias Joachim Geisler, openwebcraft <matthiasjg@openwebcraft.com>
 */

 public class Journal.ZipArchiveHandler : Object {
    ...
    private const string UNARCHIVED_PREFIX = ".~lock.trimirjournal.";
    ...
    protected static Json.Array get_content_as_json (File file) {
        try {
            ...
            if (root_node.get_node_type () == Json.NodeType.ARRAY) {
                ...
                warning ("Unexpected element type %s\n", root_node.type_name ());
