...
public abstract class Journal.TagPopover<T> : Gtk.EventBox {
    ...
    protected TagPopover (string placeholder, string? icon_name = null) {
        Object (
            icon_name: icon_name,
    ...
    class construct {
        set_css_name ("tag-popover");
    }

    static construct {
        style_provider = new Gtk.CssProvider ();
        style_provider.load_from_resource ("io/trimir/journal/TagPopover.css");
    }
