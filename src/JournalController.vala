...
class Journal.JournalController : Object {
    static JournalController __instance;
    ...
    public static JournalController sharedInstance() {
        if ( __instance == null ) {
            __instance = new Journal.JournalController();
        }
        return __instance;
    }
